...
// a. First Name
// alert("My First Name is Shiraz");

// b. Last Name
// alert("My Last Name is Shaikh");

// c. Email
// alert("My Email is sheerazshaikh965@gmail.com");

// d. Phone Number
// alert("My Contact Number is 03163993163");

// e. Password
// alert("The Password is Pakistan")
...
// Q7. Write a statement that assigns to pressure the result of 4 / 2 * 4, clarified with parentheses, producing 0.5.
// var pressure = 4 / (2 * 4);
...
// var country = prompt("Enter Country Name","China");
...
// Q2. This is the first line of an if statement:
// if (x === y) {
...
// var firstName = "Shiraz";
// var lastName = "Shaikh";
// var inpFirstName = prompt("Enter First Name");
// var inpLastName = prompt("Enter Last Name");
// if(firstName == inpFirstName && lastName == inpLastName){
//     alert("Congratulations!! Your Name Matches");
// }
// else{
//     alert("Sorry!! Your Name doesn't Match")
// }
...
// Q3. Code the first line of an if statement that avoids the nesting above by testing for multiple conditions.
// if (a === 1) {
//  if (c === "Max") {
// alert("OK");
//  }
